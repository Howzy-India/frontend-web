      ...
      >
        ...
        {step === 'phone' ? (
          <form onSubmit={handleSendOtp} className="space-y-4">
            <div className="flex items-center bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-300">
              <div className="flex items-center gap-2 px-4 py-3.5 border-r border-slate-200 bg-white/60 shrink-0">
              ...
              <input
                ...
                required
                maxLength={10}
                className="flex-1 bg-transparent py-3.5 px-4 text-sm font-sans text-center outline-none placeholder:text-slate-400"
              />
            </div>
