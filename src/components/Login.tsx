            ...
            <div className="max-w-xs mx-auto space-y-3">
              <div className="flex items-center bg-white border border-slate-200 rounded-2xl overflow-hidden transition-all focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20">
                ...
                <input
                  ...
                  required
                  maxLength={10}
                  className="flex-1 bg-transparent py-3.5 px-4 text-sm font-semibold font-sans text-slate-700 text-left tracking-[0.28em] outline-none placeholder:text-slate-400 placeholder:font-normal placeholder:tracking-normal"
                />
              </div>
