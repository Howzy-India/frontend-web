      ...
      >
        ...
        <div className="flex bg-slate-100 p-1 rounded-xl mb-6">
          <button
            ...
            className={`flex-1 py-2 text-sm font-bold rounded-lg transition-all ${loginMethod === 'google' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
          >
            Google
          </button>
          <button
